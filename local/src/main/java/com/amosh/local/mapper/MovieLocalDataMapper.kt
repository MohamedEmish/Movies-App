...
class MovieLocalDataMapper @Inject constructor() : Mapper<MovieLocalModel, MovieDTO> {

    override fun from(i: MovieLocalModel?): MovieDTO {
        return MovieDTO(
            id = i?.id ?: 0,
            adult = i?.adult ?: false,
    ...
    override fun to(o: MovieDTO?): MovieLocalModel {
